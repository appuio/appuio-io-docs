...
** xref:appuio-cloud:ROOT:explanation/decisions/dns-naming.adoc[DNS naming scheme]
** xref:appuio-cloud:ROOT:explanation/decisions/zone-naming.adoc[Zone naming scheme]
