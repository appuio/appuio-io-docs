...
[qanda]
Built-in https://docs.openshift.com/container-platform/4.9/logging/cluster-logging.html[RedHat OpenShift Logging]::
+
...
A short retention period is chosen to ensure good performance and ease of operation and maintenance. If more retention is needed log forwarding to a custom system https://access.redhat.com/documentation/en-us/openshift_container_platform/4.9/html/logging/cluster-logging-external[can be configured].
