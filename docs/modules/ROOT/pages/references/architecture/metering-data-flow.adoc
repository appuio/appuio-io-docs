...
To allow displaying individual factors which contribute to a fact, the system knows the concept of sub queries and fact properties.
...
The sub query results are attached as properties to the fact of the main query.
