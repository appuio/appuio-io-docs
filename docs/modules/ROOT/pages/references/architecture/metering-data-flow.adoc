...
The product that's billed is the used memory and is refered to as _appuio_cloud_memory_.
...
It also holds meta data associated with the fact, for example the unit and the description to be shown for the line item on the invoice.
